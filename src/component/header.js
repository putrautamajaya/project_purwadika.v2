...
import { onLogOut, keepLogin, cookieCheck, keepLoginAdmin } from '../actionCreator';
...
export default connect(mapStateToProps,{ onLogOut, keepLogin, cookieCheck, keepLoginAdmin })(header);
